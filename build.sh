...
git clone -q --depth=1 https://github.com/XSans0/WeebX-Clang/releases/download/WeebX-Clang-18.1.8-release/WeebX-Clang-18.1.8.tar.gz $HOME/vayu/clang
tar -xvzf $HOME/vayu/clang/WeebX-Clang-18.1.8.tar.gz
